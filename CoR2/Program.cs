...
namespace CoR2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PurchaseOrder p = new PurchaseOrder(20, 69, "Spices");
            jennifer.ProcessRequest(p);           

            p = new PurchaseOrder(300, 1389, "Fresh Veggies");
            jennifer.ProcessRequest(p);            

            p = new PurchaseOrder(500, 4823.99, "Beef");
            jennifer.ProcessRequest(p);
            
            p = new PurchaseOrder(4, 12099, "Ovens");
            jennifer.ProcessRequest(p);            
